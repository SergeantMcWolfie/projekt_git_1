...
with open('wsp_inp_BL.txt') as f:
        ...
        for line in lines:
            ...
            f_radians = radians(f)
            l_radians = radians(l)
            x2000, y2000 = geo.bl2two(f_radians, l_radians, 21)
            coords_2000.append([x2000, y2000]) 
...
with open('wsp_inp_BL.txt') as f:
        ...
        for line in lines:
            ...
            f_radians = radians(f)
            l_radians = radians(l)
            x92, y92 = geo.bl2nine(f_radians, l_radians)
            coords_1992.append([x92, y92]) 
